---
title: "Publish devlog for fast cache-first narration mode."
date: 2026-06-05T20:14:37Z
slug: publish-devlog-for-fast-cache-first-narration-mode
author: Otto Vernal
tags: [devlog, auto]
commit: f8b15d7
excerpt: Publish devlog for fast cache-first narration mode.
---
Shipped as **`f8b15d7`**.
...
```text
Adds a post documenting commit ad4ec82 and the new live-call budget behavior for narrated runs.
...
![Devlog illustration: Publish devlog for fast cache-first narration mode.](/blog/assets/visuals/illustrations/publish-devlog-for-fast-cache-first-narration-mode.svg)
