---
title: "Publish devlog for contract intel links."
date: 2026-06-05T20:55:40Z
slug: publish-devlog-for-contract-intel-links
author: Otto Vernal
tags: [devlog, auto]
commit: 311aaac
excerpt: Publish devlog for contract intel links.
---
Shipped as **`311aaac`**.
...
```text
Documents the job-board dossier link pass and validation for 95de186.

```

Files touched in this slice included:

- `public/blog/content/2026-06-05-link-contracts-to-campaign-intel-threads.md`
...
![Devlog illustration: Publish devlog for contract intel links.](/blog/assets/visuals/illustrations/publish-devlog-for-contract-intel-links.svg)
